...
public class MediaGalleryBannerModel {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MediaGalleryBannerModel.class);
    ...
    @PostConstruct
    protected void init() {
        LOG.debug("Initializing MediaGalleryBannerModel for resource: {}", currentResource.getPath());
    ...
    public static class SlideItem {
        ...
        public String[] getOverlayLabels() { return overlayLabels; }
